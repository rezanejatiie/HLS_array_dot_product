...
`define AUTOTB_DUT      hw_dot_product
`define AUTOTB_DUT_INST AESL_inst_hw_dot_product
`define AUTOTB_TOP      apatb_hw_dot_product_top
`define AUTOTB_LAT_RESULT_FILE "hw_dot_product.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hw_dot_product.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hw_dot_product_top
...
`define AUTOTB_TVIN_a  "../tv/cdatafile/c.hw_dot_product.autotvin_a.dat"
`define AUTOTB_TVIN_b  "../tv/cdatafile/c.hw_dot_product.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.hw_dot_product.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.hw_dot_product.autotvin_b.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.hw_dot_product.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.hw_dot_product.autotvout_out_r.dat"
module `AUTOTB_TOP;
