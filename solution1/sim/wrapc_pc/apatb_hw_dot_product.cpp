...
#define AUTOTB_TVOUT_PC_out_r  "../tv/rtldatafile/rtl.hw_dot_product.autotvout_out_r.dat"
...
extern void hw_dot_product (
int a[10],
int b[10],
int (&out));

void AESL_WRAP_hw_dot_product (
int a[10],
int b[10],
int (&out))
{
					...
					// bitslice(31, 0)
					{
						...
						// celement: out(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								if (&(out) != NULL) // check the null address if the c port is array or others
								{
									out = (out_lv0_0_0_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* a_tvin_wrapc_buffer = new sc_bv<32>[10];
		...
		tcl_file.set_num(10, &tcl_file.a_depth);
		...
		sc_bv<32>* b_tvin_wrapc_buffer = new sc_bv<32>[10];
		...
		tcl_file.set_num(10, &tcl_file.b_depth);
