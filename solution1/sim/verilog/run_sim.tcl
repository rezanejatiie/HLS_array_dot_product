...
if {[file isfile hw_dot_product.autotvin.dat]} {
	file delete -force hw_dot_product.autotvin.dat
}

if {[file isfile hw_dot_product.autotvout.dat]} {
	file delete -force hw_dot_product.autotvout.dat
}
